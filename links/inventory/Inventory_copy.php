        ...
        <div class="container">
            ...
            <section class="content" id="Inventory">
                ...
                <div class="content_page">
                    ...
                    <p class="lead">You’ve now seen how it was all put together
                        I would like for you to take an opportunity to see it in action.
                        <br><br>
                        Using php, I brought the database to the website. Utilizing the table below you can see the query in action two ways: Pull up numbers from a ‘static Monday morning count’ or use the drop down bar to ‘UPDATE’ the on hand numbers to query out new results. 
                        <br><br>
                        Enjoy!</p>
